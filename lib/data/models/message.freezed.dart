...
/// 'email'); null on legacy rows written before channel attribution.
 String? get channelType;/// Team member who sent this outbound message ("Sent by …" attribution,
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,direction,body,status,messageType,mediaUrl,mediaMimeType,locationLatitude,locationLongitude,locationName,locationAddress,const DeepCollectionEquality().hash(contactsData),transcription,transcriptionStatus,reaction,const DeepCollectionEquality().hash(providerRawPayload),templateIdRaw,const DeepCollectionEquality().hash(templateData),senderId,channelType,sentByUserName,deletedForEveryoneAt,const DeepCollectionEquality().hash(interactiveMetadata),createdAt]);

@override
String toString() {
  return 'Message(id: $id, direction: $direction, body: $body, status: $status, messageType: $messageType, mediaUrl: $mediaUrl, mediaMimeType: $mediaMimeType, locationLatitude: $locationLatitude, locationLongitude: $locationLongitude, locationName: $locationName, locationAddress: $locationAddress, contactsData: $contactsData, transcription: $transcription, transcriptionStatus: $transcriptionStatus, reaction: $reaction, providerRawPayload: $providerRawPayload, templateIdRaw: $templateIdRaw, templateData: $templateData, senderId: $senderId, channelType: $channelType, sentByUserName: $sentByUserName, deletedForEveryoneAt: $deletedForEveryoneAt, interactiveMetadata: $interactiveMetadata, createdAt: $createdAt)';
}
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(unknownEnumValue: MessageDirection.inbound)  MessageDirection direction,  String body, @JsonKey(unknownEnumValue: MessageStatus.sent)  MessageStatus status, @JsonKey(unknownEnumValue: MessageType.unknown)  MessageType messageType,  String? mediaUrl,  String? mediaMimeType,  String? locationLatitude,  String? locationLongitude,  String? locationName,  String? locationAddress,  List<dynamic>? contactsData,  String? transcription,  String? transcriptionStatus,  String? reaction,  Map<String, dynamic>? providerRawPayload, @JsonKey(name: 'templateId')  String? templateIdRaw,  Map<String, dynamic>? templateData,  String? senderId,  String? channelType,  String? sentByUserName,  String? deletedForEveryoneAt,  Map<String, dynamic>? interactiveMetadata,  String createdAt)  $default,) {final _that = this;
switch (_that) {
case _Message():
return $default(_that.id,_that.direction,_that.body,_that.status,_that.messageType,_that.mediaUrl,_that.mediaMimeType,_that.locationLatitude,_that.locationLongitude,_that.locationName,_that.locationAddress,_that.contactsData,_that.transcription,_that.transcriptionStatus,_that.reaction,_that.providerRawPayload,_that.templateIdRaw,_that.templateData,_that.senderId,_that.channelType,_that.sentByUserName,_that.deletedForEveryoneAt,_that.interactiveMetadata,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,direction,body,status,messageType,mediaUrl,mediaMimeType,locationLatitude,locationLongitude,locationName,locationAddress,const DeepCollectionEquality().hash(_contactsData),transcription,transcriptionStatus,reaction,const DeepCollectionEquality().hash(_providerRawPayload),templateIdRaw,const DeepCollectionEquality().hash(_templateData),senderId,channelType,sentByUserName,deletedForEveryoneAt,const DeepCollectionEquality().hash(_interactiveMetadata),createdAt]);
