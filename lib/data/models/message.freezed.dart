...
/// rows written before sender attribution existed.
 String? get senderId;/// Originating channel ('whatsapp' | 'instagram' | 'messenger' | 'sms' |
/// 'email'); null on legacy rows written before channel attribution.
 String? get channelType;/// Channel account that carried a non-WhatsApp message (the channel
...
/// on legacy rows written before channel attribution.
 String? get channelAccountId;/// Channel-specific metadata the IG/Messenger webhook handler stores on
...
/// WhatsApp rows and non-human-agent outbound channel sends.
 Map<String, dynamic>? get channelPayload;/// Team member who sent this outbound message ("Sent by …" attribution,
...
/// body/media and the bubble renders a "message deleted" placeholder.
 String? get deletedForEveryoneAt;/// Structured display metadata for interactive messages — mirrors the
...
/// `subtotalMinor`/`currency`). Null on every other message type.
 Map<String, dynamic>? get interactiveMetadata; String get createdAt;
...
@useResult
$Res call({
 String id,@JsonKey(unknownEnumValue: MessageDirection.inbound) MessageDirection direction, String body,@JsonKey(unknownEnumValue: MessageStatus.sent) MessageStatus status,@JsonKey(unknownEnumValue: MessageType.unknown) MessageType messageType, String? mediaUrl, String? mediaMimeType, String? locationLatitude, String? locationLongitude, String? locationName, String? locationAddress, List<dynamic>? contactsData, String? transcription, String? transcriptionStatus, String? reaction, Map<String, dynamic>? providerRawPayload,@JsonKey(name: 'templateId') String? templateIdRaw, Map<String, dynamic>? templateData, String? senderId, String? channelType, String? channelAccountId, Map<String, dynamic>? channelPayload, String? sentByUserName, String? deletedForEveryoneAt, Map<String, dynamic>? interactiveMetadata, String createdAt
});
...
as String?,channelAccountId: freezed == channelAccountId ? _self.channelAccountId : channelAccountId // ignore: cast_nullable_to_non_nullable
as String?,channelPayload: freezed == channelPayload ? _self.channelPayload : channelPayload // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,sentByUserName: freezed == sentByUserName ? _self.sentByUserName : sentByUserName // ignore: cast_nullable_to_non_nullable
...
as String?,interactiveMetadata: freezed == interactiveMetadata ? _self.interactiveMetadata : interactiveMetadata // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(unknownEnumValue: MessageDirection.inbound)  MessageDirection direction,  String body, @JsonKey(unknownEnumValue: MessageStatus.sent)  MessageStatus status, @JsonKey(unknownEnumValue: MessageType.unknown)  MessageType messageType,  String? mediaUrl,  String? mediaMimeType,  String? locationLatitude,  String? locationLongitude,  String? locationName,  String? locationAddress,  List<dynamic>? contactsData,  String? transcription,  String? transcriptionStatus,  String? reaction,  Map<String, dynamic>? providerRawPayload, @JsonKey(name: 'templateId')  String? templateIdRaw,  Map<String, dynamic>? templateData,  String? senderId,  String? channelType,  String? channelAccountId,  Map<String, dynamic>? channelPayload,  String? sentByUserName,  String? deletedForEveryoneAt,  Map<String, dynamic>? interactiveMetadata,  String createdAt)  $default,) {final _that = this;
switch (_that) {
case _Message():
return $default(_that.id,_that.direction,_that.body,_that.status,_that.messageType,_that.mediaUrl,_that.mediaMimeType,_that.locationLatitude,_that.locationLongitude,_that.locationName,_that.locationAddress,_that.contactsData,_that.transcription,_that.transcriptionStatus,_that.reaction,_that.providerRawPayload,_that.templateIdRaw,_that.templateData,_that.senderId,_that.channelType,_that.channelAccountId,_that.channelPayload,_that.sentByUserName,_that.deletedForEveryoneAt,_that.interactiveMetadata,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
class _Message extends Message {
  const _Message({required this.id, @JsonKey(unknownEnumValue: MessageDirection.inbound) required this.direction, this.body = '', @JsonKey(unknownEnumValue: MessageStatus.sent) this.status = MessageStatus.sent, @JsonKey(unknownEnumValue: MessageType.unknown) this.messageType = MessageType.text, this.mediaUrl, this.mediaMimeType, this.locationLatitude, this.locationLongitude, this.locationName, this.locationAddress, final  List<dynamic>? contactsData, this.transcription, this.transcriptionStatus, this.reaction, final  Map<String, dynamic>? providerRawPayload, @JsonKey(name: 'templateId') this.templateIdRaw, final  Map<String, dynamic>? templateData, this.senderId, this.channelType, this.channelAccountId, final  Map<String, dynamic>? channelPayload, this.sentByUserName, this.deletedForEveryoneAt, final  Map<String, dynamic>? interactiveMetadata, required this.createdAt}): _contactsData = contactsData,_providerRawPayload = providerRawPayload,_templateData = templateData,_channelPayload = channelPayload,_interactiveMetadata = interactiveMetadata,super._();
...
/// story_url}`), raw `attachments`, `postback`, `quick_reply`. Null on
/// WhatsApp rows and non-human-agent outbound channel sends.
 final  Map<String, dynamic>? _channelPayload;
/// Channel-specific metadata the IG/Messenger webhook handler stores on
/// inbound rows: `story_context` (`{kind: 'reply'|'mention', story_id,
/// story_url}`), raw `attachments`, `postback`, `quick_reply`. Null on
/// WhatsApp rows and non-human-agent outbound channel sends.
@override Map<String, dynamic>? get channelPayload {
  final value = _channelPayload;
  if (value == null) return null;
  if (_channelPayload is EqualUnmodifiableMapView) return _channelPayload;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(value);
}
...
/// writes back after parsing the cart (`orderId`/`itemCount`/
/// `subtotalMinor`/`currency`). Null on every other message type.
 final  Map<String, dynamic>? _interactiveMetadata;
/// Structured display metadata for interactive messages — mirrors the
/// portal's `Message.interactiveMetadata`. Outbound product/catalog
/// sends carry `catalogId` + `productRetailerId`/`sections`/`bodyText`;
/// inbound `order` (cart) rows carry the snapshot OrderCaptureService
/// writes back after parsing the cart (`orderId`/`itemCount`/
/// `subtotalMinor`/`currency`). Null on every other message type.
@override Map<String, dynamic>? get interactiveMetadata {
  final value = _interactiveMetadata;
  if (value == null) return null;
  if (_interactiveMetadata is EqualUnmodifiableMapView) return _interactiveMetadata;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(value);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Message&&(identical(other.id, id) || other.id == id)&&(identical(other.direction, direction) || other.direction == direction)&&(identical(other.body, body) || other.body == body)&&(identical(other.status, status) || other.status == status)&&(identical(other.messageType, messageType) || other.messageType == messageType)&&(identical(other.mediaUrl, mediaUrl) || other.mediaUrl == mediaUrl)&&(identical(other.mediaMimeType, mediaMimeType) || other.mediaMimeType == mediaMimeType)&&(identical(other.locationLatitude, locationLatitude) || other.locationLatitude == locationLatitude)&&(identical(other.locationLongitude, locationLongitude) || other.locationLongitude == locationLongitude)&&(identical(other.locationName, locationName) || other.locationName == locationName)&&(identical(other.locationAddress, locationAddress) || other.locationAddress == locationAddress)&&const DeepCollectionEquality().equals(other._contactsData, _contactsData)&&(identical(other.transcription, transcription) || other.transcription == transcription)&&(identical(other.transcriptionStatus, transcriptionStatus) || other.transcriptionStatus == transcriptionStatus)&&(identical(other.reaction, reaction) || other.reaction == reaction)&&const DeepCollectionEquality().equals(other._providerRawPayload, _providerRawPayload)&&(identical(other.templateIdRaw, templateIdRaw) || other.templateIdRaw == templateIdRaw)&&const DeepCollectionEquality().equals(other._templateData, _templateData)&&(identical(other.senderId, senderId) || other.senderId == senderId)&&(identical(other.channelType, channelType) || other.channelType == channelType)&&(identical(other.channelAccountId, channelAccountId) || other.channelAccountId == channelAccountId)&&const DeepCollectionEquality().equals(other._channelPayload, _channelPayload)&&(identical(other.sentByUserName, sentByUserName) || other.sentByUserName == sentByUserName)&&(identical(other.deletedForEveryoneAt, deletedForEveryoneAt) || other.deletedForEveryoneAt == deletedForEveryoneAt)&&const DeepCollectionEquality().equals(other._interactiveMetadata, _interactiveMetadata)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,direction,body,status,messageType,mediaUrl,mediaMimeType,locationLatitude,locationLongitude,locationName,locationAddress,const DeepCollectionEquality().hash(_contactsData),transcription,transcriptionStatus,reaction,const DeepCollectionEquality().hash(_providerRawPayload),templateIdRaw,const DeepCollectionEquality().hash(_templateData),senderId,channelType,channelAccountId,const DeepCollectionEquality().hash(_channelPayload),sentByUserName,deletedForEveryoneAt,const DeepCollectionEquality().hash(_interactiveMetadata),createdAt]);
...
as String?,channelType: freezed == channelType ? _self.channelType : channelType // ignore: cast_nullable_to_non_nullable
as String?,channelAccountId: freezed == channelAccountId ? _self.channelAccountId : channelAccountId // ignore: cast_nullable_to_non_nullable
as String?,channelPayload: freezed == channelPayload ? _self._channelPayload : channelPayload // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,sentByUserName: freezed == sentByUserName ? _self.sentByUserName : sentByUserName // ignore: cast_nullable_to_non_nullable
as String?,deletedForEveryoneAt: freezed == deletedForEveryoneAt ? _self.deletedForEveryoneAt : deletedForEveryoneAt // ignore: cast_nullable_to_non_nullable
as String?,interactiveMetadata: freezed == interactiveMetadata ? _self._interactiveMetadata : interactiveMetadata // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
