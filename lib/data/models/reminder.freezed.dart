...
mixin _$Reminder {
 ...
 String get id; String? get clientId; String? get messageId; String get assignedToUserId; String get createdByUserId; String get title; String? get notes;@JsonKey(unknownEnumValue: ReminderPriority.normal) ReminderPriority get priority; String get dueAt;@JsonKey(unknownEnumValue: ReminderStatus.pending) ReminderStatus get status; int get snoozeCount;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,clientId,messageId,assignedToUserId,createdByUserId,title,notes,priority,dueAt,status,snoozeCount);

@override
String toString() {
  return 'Reminder(id: $id, clientId: $clientId, messageId: $messageId, assignedToUserId: $assignedToUserId, createdByUserId: $createdByUserId, title: $title, notes: $notes, priority: $priority, dueAt: $dueAt, status: $status, snoozeCount: $snoozeCount)';
}
...
@useResult
$Res call({
 String id, String? clientId, String? messageId, String assignedToUserId, String createdByUserId, String title, String? notes,@JsonKey(unknownEnumValue: ReminderPriority.normal) ReminderPriority priority, String dueAt,@JsonKey(unknownEnumValue: ReminderStatus.pending) ReminderStatus status, int snoozeCount
});
...
/// Create a copy of Reminder
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? clientId = freezed,Object? messageId = freezed,Object? assignedToUserId = null,Object? createdByUserId = null,Object? title = null,Object? notes = freezed,Object? priority = null,Object? dueAt = null,Object? status = null,Object? snoozeCount = null,}) {
...
as String?,assignedToUserId: null == assignedToUserId ? _self.assignedToUserId : assignedToUserId // ignore: cast_nullable_to_non_nullable
...
as ReminderStatus,snoozeCount: null == snoozeCount ? _self.snoozeCount : snoozeCount // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class _Reminder extends Reminder {
  const _Reminder({required this.id, this.clientId, this.messageId, required this.assignedToUserId, required this.createdByUserId, required this.title, this.notes, @JsonKey(unknownEnumValue: ReminderPriority.normal) this.priority = ReminderPriority.normal, required this.dueAt, @JsonKey(unknownEnumValue: ReminderStatus.pending) this.status = ReminderStatus.pending, this.snoozeCount = 0}): super._();
...
/// Create a copy of Reminder
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? clientId = freezed,Object? messageId = freezed,Object? assignedToUserId = null,Object? createdByUserId = null,Object? title = null,Object? notes = freezed,Object? priority = null,Object? dueAt = null,Object? status = null,Object? snoozeCount = null,}) {
